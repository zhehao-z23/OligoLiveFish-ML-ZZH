...
if n==0
    out=[];
    warning('pkfnd:nothingAboveThresh','No pixels above the given threshold.');
    return;
end
mx=[];
%convert index from find to row and column

% 2008.08.10 CJI [Note, could use [r,c,v]=find(im>th) to get row and column
% and save on an operation]
